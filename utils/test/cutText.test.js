...
describe('CutText', () => {
  it('should return en error if "content" arg is not a string', () => {
  ...
  it('should return en error if "content" arg length is 0', () => {
    expect(cutText('', 20)).to.equal('Error');
  });

  it('should return en error if "maxLength" is not a number', () => {
  ...
  it('should return en error if "maxLength" is lower or equal 0', () => {
